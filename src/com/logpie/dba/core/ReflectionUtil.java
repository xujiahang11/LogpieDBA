...
class ReflectionUtil {
     ...
     */
    static Object buildInstanceByDefaultConstructor(Class<?> clazz)
    {
    ...
    static Object runGetter(final Field field, final Object model)
    {
    ...
    static void runSetter(final Field field, final Object model, final Class<?> valueClazz, final Object value)
    {
        Assert.notNull(model, "Model must not be null");
